...
const I18N = (() => {
  ...
  const STRINGS = {
    zh: {
      ...
      'common.next': '下一步',
      'common.done': '完成',
      'tour.step0.title': '歡迎使用自行車安全地圖 🚴',
      'tour.step0.text': '這個導覽會帶你快速認識主要功能，隨時可以按「跳過」離開。',
      'tour.step1.title': '搜尋地點',
      'tour.step1.text': '輸入地點或地址後搜尋，會直接顯示那裡的友善等級評分。',
      'tour.step2.title': '🛡️ 避開危險區域',
      'tour.step2.text': '預設開啟：規劃路線時會自動避開事故熱點與低評分路段。',
      'tour.step3.title': '規劃路線',
      'tour.step3.text': '點一下搜尋列會展開這裡：輸入起點／終點後按「規劃路線」。',
      'tour.step4.title': '地圖圖層',
      'tour.step4.text': '右上角可切換 YouBike 模式、YouBike 站點與自行車道圖層。',
      'tour.step5.title': '點擊地圖評分',
      'tour.step5.text': '在地圖上點一下任一位置，就能看到那條路的友善等級。',
      'tour.step6.title': '⭐ 我的最愛',
      'tour.step6.text': '在這裡管理常用地址；路線起訖點的輸入其實在最上方的搜尋列。',
      'tour.step7.title': '🚩 回報問題',
      'tour.step7.text': '發現路況異常嗎？在這裡回報，會即時顯示在地圖上給大家看到。',
      'tour.step8.title': '更多設定',
    ...
    en: {
      ...
      'common.next': 'Next',
      'common.done': 'Done',
      'tour.step0.title': 'Welcome to Bicycle Safety Map 🚴',
      'tour.step0.text': 'This tour walks you through the main features. Tap "Skip" to leave at any time.',
      'tour.step1.title': 'Search for a place',
      'tour.step1.text': 'Search for a place or address to see its friendliness grade right away.',
      'tour.step2.title': '🛡️ Avoid danger zones',
      'tour.step2.text': 'On by default: route planning steers around accident hotspots and low-rated roads.',
      'tour.step3.title': 'Plan a route',
      'tour.step3.text': 'Tap the search bar to open this panel, enter a start and destination, then tap "Plan route".',
      'tour.step4.title': 'Map layers',
      'tour.step4.text': 'Use the top-right buttons to toggle YouBike mode, YouBike stations, and bike lanes.',
      'tour.step5.title': 'Tap the map for a grade',
      'tour.step5.text': 'Tap anywhere on the map to see how friendly that road is.',
      'tour.step6.title': '⭐ Favorites',
      'tour.step6.text': 'Manage your saved places here. Start and destination inputs live in the search bar at the top.',
      'tour.step7.title': '🚩 Report an issue',
      'tour.step7.text': 'Spotted a road problem? Report it here and it shows up on the map for everyone right away.',
      'tour.step8.title': 'More',
